...
\noindent\textbf{例 12.1.1}\quad 设函数 $f(x)=x(-\pi\le x<\pi)$, 求 $f(x)$ 的傅里叶级数。
...
\noindent\textbf{例 12.1.5}\quad 求 $f(x)=x\cos x\left(-\dfrac{\pi}{2}\le x<\dfrac{\pi}{2}\right)$ 的傅里叶级数。
...
\noindent\textbf{例 12.2.1}\quad 函数 $f(x)=x(-\pi\le x<\pi)$ 的傅里叶级数为
\[
...
\noindent\textbf{例 12.2.5}\quad 函数 $f(x)=x\cos x\left(-\dfrac{\pi}{2}\le x<\dfrac{\pi}{2}\right)$ 的傅里叶级数为
\[
